  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input type="text" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })}
            placeholder="Ej: Promo WhatsApp julio" required
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 mb-1.5">Número remitente</label>
      ...
      <div>
            ...
            {!fileName ? (
              ...
              <div className="flex items-center gap-3 px-4 py-3 bg-emerald-50 border border-emerald-200 rounded-lg">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-emerald-600">{fileContacts.length} contactos cargados</p>
                </div>
                <button type="button" onClick={clearFile} className="p-1 hover:bg-emerald-100 rounded transition-colors">
        ...
        {tab === 'contactos' && (
          <ContactsPicker accentClass="text-emerald-600" onChange={setPickedContacts} />
        )}
          ...
          <div>
            <div className="relative">
              ...
              <textarea value={numbers} onChange={(e) => setNumbers(e.target.value)}
                placeholder={"+52551234567\n+52559876543\n+52551111111"} rows={6}
                className="w-full pl-9 pr-3.5 py-2.5 border border-slate-300 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent resize-none" />
            </div>
